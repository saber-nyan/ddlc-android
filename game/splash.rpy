...
label splashscreen:
    ...
    if not firstrun:
        if persistent.first_run:
            ...
            scene black
            menu:
                "Были найдены файлы сохранений. Вы хотите удалить существующие данные и начать заново?"
                "Да, удалить мои сохранения.":
                    "Удаление сохранений...{nw}"
                    python:
                        delete_all_saves()
                        renpy.loadsave.location.unlink_persistent()
                        renpy.persistent.should_save_persistent = False
                        renpy.utter_restart()
                "Нет, продолжить с момента, на котором я остановился.":
                    pass
